...
import michalnithesh.michal.music.recognition.MusicRecognitionService
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import michalnithesh.michal.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "michalnithesh.michal.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "michalnithesh.michal.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "michalnithesh.michal.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "michalnithesh.michal.music.widget.recognizer.RESET"
    }
}
